...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h1>Approve Intellectual Property of {{ $user->name }}</h1>

                <form action="/approveIntProp/{{ $user->id }}/{{ $intProp->id }}" method="post">
                @csrf
                @method('put')
                ...
                {{-- Approve or reject intellectual property --}}
                <p class="form-group">
                    <label>Intellectual property approval</label>
                        <input
